...
class AthleteRepositoryImplTest {
    ...
    fun addAthlete_athleteIsRetrievable() = runTest {
        val athlete = Athlete(id = AthleteId("1"), name = "John Doe")
    ...
    fun addAthlete_replacesExistingAthleteWithSameId() = runTest {
        val athlete1 = Athlete(id = AthleteId("1"), name = "John Doe")
        val athlete2 = Athlete(id = AthleteId("1"), name = "Jane Doe")
    ...
    fun getAthleteById_returnsCorrectAthlete() = runTest {
        val athlete1 = Athlete(id = AthleteId("1"), name = "John Doe")
        val athlete2 = Athlete(id = AthleteId("2"), name = "Jane Smith")

        repository.addAthlete(athlete1)
        repository.addAthlete(athlete2)

        val retrieved = repository.getAthleteById(AthleteId("2"))
    ...
    fun getAthleteById_returnsNullWhenNotFound() = runTest {
        val retrieved = repository.getAthleteById(AthleteId("nonexistent"))
    ...
    fun deleteAthlete_removesAthlete() = runTest {
        ...
        repository.deleteAthlete(AthleteId("1"))
    ...
    fun getAllAthletes_returnsSortedByName() = runTest {
        val athletes = listOf(
            Athlete(id = AthleteId("1"), name = "Charlie"),
            Athlete(id = AthleteId("2"), name = "Alice"),
            Athlete(id = AthleteId("3"), name = "Bob")
        )
    ...
    fun addMultipleAthletes_allRetrievable() = runTest {
        val athletes = (1..10).map { Athlete(id = AthleteId("$it"), name = "Athlete $it") }
