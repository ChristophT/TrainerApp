package de.hardtthelen.trainerapp.presentation.theme
...
val TimerActive = Color(0xFF00C853)
val TimerStopped = Color(0xFF0061A4)
...
val TimerActiveDark = Color(0xFF69F0AE)
val TimerStoppedDark = Color(0xFF9ECAFF)
